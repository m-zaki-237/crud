...
const User = () => {
  ...
  useEffect(() => {
    const getAll = async () => {
      try {
        const res = await axios.get('https://crud-nine-black.vercel.app/api/user/getAll')
        if (res.data.success) {
  ...
  const deleteUser = async (userID) => {
    try {
      const res = await axios.delete(`https://crud-nine-black.vercel.app/api/user/delete/${userID}`)
      if(res.data.success){
